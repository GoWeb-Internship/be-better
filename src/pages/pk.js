...
const pk = () => {
  return (
    ...
    <div>
        <StaticImage className='bg-scroll h-52 bg-center z-0 top-0 left-0 absolute' src="https://thumb.tildacdn.com/tild3865-3734-4436-b930-626164373038/-/format/webp/mike-aunzo-yYSnv8meS.jpg"/ >
       
        <div className=" relative h-52 w-full overflow-hidden">
           
            <div className='table box-border absolute visible z-2 top-4 left-12'>
            <a href="/" className='no-underline border-solid border-transparent bg-center rotate-180 block table-cell'>
                <img className='cursor-pointer visible box-content block w-full'  src='https://thumb.tildacdn.com/tild3431-3937-4633-b465-303734313661/-/resize/70x/-/format/webp/photo.png' data-original='https://static.tildacdn.com/tild3431-3937-4633-b465-303734313661/photo.png' ingfield='tn_img_1649831904378'/>
            </a>
            </div>
           <div className='table box-border absolute visible z-3 left-12 top-4 w-18 '>
            <a href='/' className='cursor-pointer font-normal text-base w-full font-normal invisible'>назад на стр</a>
            <a href='/' className='cursor-pointer font-normal text-base font-sans visible shadow-none text-white'>Назад</a>
           </div>
           
        <div  className=" z-0 box-border table bg-no-repeat top-16 text-center text-2xl z-1 absolute left-0 w-full">
        <div className="text-3xl z-1 text-center visible font-semibold border-solid w-full text-white">Политика конфиденциальности</div>
        </div>
      
        </div>
        <div className="pt-2 pb-1.5 ">
        <div className="float-none px-5 m-0 box-border w-full max-w-full block">
        <div field="text" className="text-base  font-light font-sans title: black">
            <strong className="font-bold text-base">Политика в отношении обработки персональных данных</strong>
            <br/>
            1. Общие положения
            <br/>
...
<br/>
14.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты yshayenko@gmail.com.
<br/>
14.2. В данном документе будут отражены любые изменения политики обработки персональных данных Оператором. Политика действует бессрочно до замены ее новой версией.
<br/>
14.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://be-better.today/pk.
<br/>
<br/>
</div>
</div>
