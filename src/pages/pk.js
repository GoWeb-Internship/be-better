      ...
      <div className="pt-2 pb-1.5 ">
        <div className="float-none px-5 m-0 box-border w-full max-w-full block pt-14 pb-14">
          ...
          >
            ...
            соответствии с требованиями Закона Украины “О защите персональных
            данных” от 01.06.2010 г. №2297-VI (далее - Закон), а также
            Генерального регламента о защите данных (ЕС) 2016/679 от 27.04.2016
            г. (далее - Закон о персональных данных) и определяет порядок
            обработки персональных данных и меры по обеспечению безопасности
            персональных данных, предпринимаемые Шаенко Юлии Юрьевна (далее –
            Оператор).
            <br />
            ...
            установленном действующим законодательством РУ;
            <br />
            ...
            статьях 13 и 14 GDPR Закона о персональных данных, допускается, если
            ...
            условия, предусмотренные, в частности, ст. 13 и 14 GDPR Закона о
            ...
            электронной почты yshayenko@gmail.com с пометкой «Отказ от
            ...
            являются:
            <br />
            – Закона Украины “О защите персональных данных” от 01.06.2010 г.
            №2297-VI (далее - Закон), а также Генерального регламента о защите
            данных (ЕС) 2016/679 от 27.04.2016 г.;
            <br />
            ...
            https://be-better.today или направленные Оператору посредством
            ...
            предусмотренных международным договором Республики Украина или
            законом, для осуществления возложенных законодательством Республики
            Украины на оператора функций, полномочий и обязанностей.
            <br />
            ...
            законодательством Республики Украины об исполнительном производстве.
            <br />
            ...
            Оператора yshayenko@gmail.com с пометкой «Актуализация персональных
            данных».
            <br />
            ...
            yshayenko@gmail.com с пометкой «Отзыв согласия на обработку
            персональных данных».
            <br />
            ...
            интересах, определенных законодательством РУ.
            <br />
            ...
            к Оператору с помощью электронной почты yshayenko@gmail.com.
            <br />
            ...
            сети Интернет по адресу https://be-better.today/pk.
            <br />
            <br />
          </div>
        </div>
